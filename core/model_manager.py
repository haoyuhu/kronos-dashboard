...
class ModelManager:
    def __init__(self, device: str = 'cpu', max_context: int = 512, model_size: str = 'small') -> None:
        self.device = device
    ...
    def load(self, cache_dir: Optional[Path] = None) -> ModelArtifacts:
        ...
        print(f"Loading Kronos model (size={self.model_size}) from Hugging Face (using default cache)...")
        kwargs = {}
